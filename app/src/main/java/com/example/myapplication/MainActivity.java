...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button viewAllDataButton = (Button) findViewById(R.id.buttonViewAllData);
        Button getDataButton = (Button) findViewById(R.id.buttonGetData);
    ...
    public void insertData(View view){
        ...
        boolean executed=
                databaseHelper.insertToDb(fName.getText().toString(),surname.getText().toString(),Integer.parseInt(marks.getText().toString()));
        if(executed){
